...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
		...
		'name' => __( 'Footer Middle Widget Area', 'twentytwelve' ),

		'id' => 'sidebar-5',

		'description' => __( 'Appears on the bottom middle of all pages', 'twentytwelve' ),
		...
		'name' => __( 'Consultation Block Area', 'twentytwelve' ),
